  ...
  return (
    <div className="min-h-screen pt-24 md:pt-32 pb-24 md:pb-32 px-6 md:px-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_520px] gap-12 md:gap-16 mb-16 md:mb-24">
        ...
        >
          <p className="font-sans text-base md:text-[1.625rem] font-light text-ink leading-relaxed max-w-2xl mb-6 md:mb-8">
          ...
          <p className="font-sans text-base md:text-[1.625rem] font-light text-muted leading-relaxed max-w-2xl">
      ...
      {/* Experience */}
      <motion.div
        className="border-t border-card pt-10 md:pt-12 mb-16 md:mb-24"
        initial={{ opacity: 0 }}
      ...
      {/* Contact CTA */}
      <motion.div
        className="border-t border-card pt-10 md:pt-12"
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, amount: 0 }}
